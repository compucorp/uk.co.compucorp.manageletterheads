 ...
 */
class CRM_ManageLetterheads_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_ManageLetterheads_Upgrader(
        'uk.co.compucorp.manageletterheads',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_ManageLetterheads_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
